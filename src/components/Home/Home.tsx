export function Home() {
  return (
    <div id="home" className="home-container w-full h-full pt-24 pb-16 lg:pr-0 pr-5 lg:flex  items-center">
      <div className="presentation lg:w-1/2 w-full">
        <h1 className="text-dark-green font-bold lg:text-5xl text-4xl">
          Não deixe problemas pequenos se tornarem grandes,{" "}
          <b className="text-light-green">conte comigo para isso</b>
        </h1>
        <p className="text-dark-green my-5 md:text-xl text-ls font-  ">
